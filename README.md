...
cd office
npm install
npm test          # 762 tests, no network needed
...
npm test                # the engine suite — 762 checks, no windows
...
`npm run gate` is what runs before a release: 762 engine tests, 9 editing checks,
