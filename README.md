...
cd office
npm install
npm test          # 820 tests, no network needed
...
npm test                # the engine suite — 820 checks, no windows
...
`npm run gate` is what runs before a release: 820 engine tests, 9 editing checks,
