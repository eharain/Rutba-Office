...
cd office
npm install
npm test          # 727 tests, no network needed
...
npm test                # the engine suite — 727 checks, no windows
...
`npm run gate` is what runs before a release: 727 engine tests, 9 editing checks,
