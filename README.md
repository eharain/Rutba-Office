...
cd office
npm install
npm test          # 743 tests, no network needed
...
npm test                # the engine suite — 743 checks, no windows
...
`npm run gate` is what runs before a release: 743 engine tests, 9 editing checks,
