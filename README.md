...
cd office
npm install
npm test          # 770 tests, no network needed
...
npm test                # the engine suite — 770 checks, no windows
...
`npm run gate` is what runs before a release: 770 engine tests, 9 editing checks,
