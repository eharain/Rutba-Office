...
cd office
npm install
npm test          # 794 tests, no network needed
...
npm test                # the engine suite — 794 checks, no windows
...
`npm run gate` is what runs before a release: 794 engine tests, 9 editing checks,
