...
cd office
npm install
npm test          # 922 tests, no network needed
...
npm test                # the engine suite — 922 checks, no windows
...
`npm run gate` is what runs before a release: 922 engine tests, 12 editing checks,
