...
cd office
npm install
npm test          # 852 tests, no network needed
...
npm test                # the engine suite — 852 checks, no windows
...
`npm run gate` is what runs before a release: 852 engine tests, 9 editing checks,
