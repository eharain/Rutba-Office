...
cd office
npm install
npm test          # 740 tests, no network needed
...
npm test                # the engine suite — 740 checks, no windows
...
`npm run gate` is what runs before a release: 740 engine tests, 9 editing checks,
