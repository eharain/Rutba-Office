...
cd office
npm install
npm test          # 797 tests, no network needed
...
npm test                # the engine suite — 797 checks, no windows
...
`npm run gate` is what runs before a release: 797 engine tests, 9 editing checks,
