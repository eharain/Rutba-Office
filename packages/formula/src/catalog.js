...
export const FUNCTION_CATALOG = [
  ...
  stat('FORECAST', '(x, known_y\'s, known_x\'s)', 'A value on the straight line through known points'),
  stat('FORECAST.LINEAR', '(x, known_y\'s, known_x\'s)', 'A value on the straight line through known points'),
  stat('FORECAST.ETS', '(target_date, values, timeline, [seasonality], [data_completion], [aggregation])', 'A future value by exponential triple smoothing (AAA)'),
  stat('FORECAST.ETS.CONFINT', '(target_date, values, timeline, [confidence_level], [seasonality], [data_completion], [aggregation])', 'Half the width of the confidence interval round a FORECAST.ETS value'),
  stat('FORECAST.ETS.SEASONALITY', '(values, timeline, [data_completion], [aggregation])', 'The length of the repeating pattern FORECAST.ETS finds'),
