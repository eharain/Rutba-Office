...
const PATHS = {
  ...
  eyeOff: [P('M9.9 5.2A10.6 10.6 0 0 1 12 5c6.5 0 10 7 10 7a17 17 0 0 1-2.6 3.5'), P('M6.6 6.6C3.7 8.4 2 12 2 12s3.5 7 10 7a9.7 9.7 0 0 0 5.4-1.6'), P('M9.9 9.9a3 3 0 0 0 4.2 4.2'), P('m3 3 18 18')],
