...
`RUTBA_VERIFY_ONLY=pages,grips,panes,float,polish,shapes,bullets,clip,footer,find,sections,hidden,fill,pics,look,effects,bookmarks,ruler,update,viewer,links,home,freeze,zoom,fit,cards,sheetpic,providers npm run verify:apps` runs only the
