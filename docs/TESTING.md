...
`RUTBA_VERIFY_ONLY=pages,grips,panes,float,polish,shapes,bullets,fill,pics,ruler,update,viewer,links,home,freeze,fit,cards,sheetpic npm run verify:apps` runs only the
