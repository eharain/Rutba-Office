...
- Twenty-one application checks were added: the first line measured against a
  floating picture after each move; a shape dragged, resized and nudged with
  ...
  drawing; a tooltip shown and hidden; the slider zooming the window and the
  slide. The harness reads a button's tip as well as its title.
